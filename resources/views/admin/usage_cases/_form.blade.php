...
{{--      {{ Form::text('title', old('title', $usageCase->title), ['class' => 'form-control', 'required' => 'required' ]) }}--}}
{{--    </td>--}}
{{--  </tr>--}}
{{--  <tr>--}}
...
{{--      <date-picker-component :target="'public_date'" :value="{{ json_encode(old('public_date', $usageCase->public_date ? $usageCase->public_date->format('Y-m-d') : '')) }}"></date-picker-component>--}}
{{--    </td>--}}
{{--  </tr>--}}
...
{{--      <div class="row">--}}
{{--        @foreach($usageCaseCategories as $key => $val)--}}
{{--          <div class="col-md-2 py-1 ml-4 my-auto">--}}
{{--            {{ Form::checkbox('news_categories[]', $key, in_array($key, old('news_categories', $usageCase->newsCategories->pluck('id')->toArray())), ['id' => 'news_category'.$key, 'class' => 'form-check-input']) }}--}}
...
{{--      {!! Form::textarea('body', old('body', $usageCase->body ?? ''), ['class' => 'form-control', 'rows' => '10', 'required' => 'required']) !!}--}}
{{--    </td>--}}
{{--  </tr>--}}
{{--  <tr>--}}
...
{{--      {{ Form::text('description', old('description', $usageCase->description ?? ''), ['class' => 'form-control', 'required' => 'required']) }}--}}
{{--    </td>--}}
{{--  </tr>--}}
  </tbody>
</table>
